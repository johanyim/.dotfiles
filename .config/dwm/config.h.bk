...
static const char *fonts[]          = {"JetBrainsMono Nerd Font Mono:medium:size=19","Noto Sans Mono:size=18" };
static const char dmenufont[]       = "Noto Sans Mono=10";
...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { surface0, mantle, col_cyan },
